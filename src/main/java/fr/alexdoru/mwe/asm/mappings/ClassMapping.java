...
public enum ClassMapping {
    ...
    GUICHATHOOKSEARCHBOX("fr/alexdoru/mwe/asm/hooks/mc/chat/GuiChatHook_SearchBox"),
    ...
    GUINEWCHATHOOKSEARCHBOX("fr/alexdoru/mwe/asm/hooks/mc/chat/GuiNewChatHook_SearchBox"),
