...
public class MWEClassTransformer implements IClassTransformer {
    ...
    public MWEClassTransformer() {
        ...
        register(new EntityPlayerTransformer_Accessor());
        register(new EntityPlayerTransformer_FixAutoblockBypass());
        register(new EntityPlayerTransformer_ItemInUseResetFix());
        ...
        register(new GuiContainerTransformer_CustomSlotRenderer());
        ...
        register(new RenderTransformer_ModernNametags());
