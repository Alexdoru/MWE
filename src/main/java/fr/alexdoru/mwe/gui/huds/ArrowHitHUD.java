...
public class ArrowHitHUD extends AbstractRenderer {
    ...
    public boolean processMessage(ClientChatReceivedEvent event, String fmsg, String msg) {
        ...
        if (matcherArrowHit.matches()) {
            ...
            final String s = ScoreboardTracker.isInMwGame() ? StringUtil.replaceFirst(fmsg, playername, NameFormatter.getFormattedNameSimple(playername)) : fmsg;
        ...
        if (matcherRend.matches()) {
            ...
            while (matcherRend2.find()) {
                ...
                s = ScoreboardTracker.isInMwGame() ? StringUtil.replaceFirst(s, playername, NameFormatter.getFormattedNameSimple(playername)) : s;
            }
    ...
    public void render(ScaledResolution resolution) {
        ...
        if (MWEConfig.showHeadOnArrowHitHUD && skin != null) {
            ...
            RenderHelper.renderSkinHead(skin, x, y, true, 8);
        }
    }
