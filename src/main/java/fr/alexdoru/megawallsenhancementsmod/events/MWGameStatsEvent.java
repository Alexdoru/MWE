...
public class MWGameStatsEvent {
	...
	private static void onGameEnd() {
		...
		(new Thread(() -> {
			...
			try {
				...
				ChatUtil.addChatMessage((IChatComponent)new ChatComponentText(ChatUtil.getTag() + EnumChatFormatting.YELLOW + "Click to view the stats of your " + EnumChatFormatting.AQUA + "Mega Walls " + EnumChatFormatting.YELLOW + "game!")
	...
	public static boolean processMessage(String msg) {
		Matcher matcher = Pattern.compile("Random class: (\\w+)*").matcher(msg);		
		if(matcher.matches()) {
