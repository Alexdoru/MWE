...
public class ConfigHandler extends AbstractConfig {
    ...
    @ConfigProperty(category = GUI, name = "Phoenix Bond HUD", comment = "Displays the hearts healed from phoenix bond")
    ...
    @ConfigProperty(category = HITBOX, name = "Hitbox Color", comment = "A custom color for the hitboxes")
