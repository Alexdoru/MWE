...
public class GeneralInfo extends LoginData {
	...
	public IChatComponent getFormattedMessage(String formattedname,boolean a) {
		...
		IChatComponent msg = new ChatComponentText(EnumChatFormatting.AQUA + ChatUtil.bar() + "\n")
				...
				+ (this.isStaffonHypixel()||a? "" : EnumChatFormatting.GREEN + "Status : " + (this.isOnline() ? EnumChatFormatting.DARK_GREEN + "Online" :
