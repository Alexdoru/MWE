...
public class MegaWallsClassStats {
    ...
    public MegaWallsClassStats(JsonObject playerData, String classname) {
        ...
        int classname_final_kills_standard = JsonUtil.getInt(mwdata, this.classname + "_final_kills_standard");
        this.classname_final_assists_standard = JsonUtil.getInt(mwdata, this.classname + "_final_assists_standard");
        int classname_wins_standard = JsonUtil.getInt(mwdata, this.classname + "_wins_standard");
        this.classpoints = classname_final_kills_standard + this.classname_final_assists_standard + classname_wins_standard * 10;
    ...
    public IChatComponent getGameStatMessage(String formattedname) {
        ...
        String[][] matrix1 = {
                {
                        EnumChatFormatting.GREEN + "Kills : " + EnumChatFormatting.GOLD + formatInt(this.classname_kills) + " ",
                        EnumChatFormatting.GREEN + "Assists : " + EnumChatFormatting.GOLD + formatInt(this.classname_assists)
                },

                {
                        EnumChatFormatting.GREEN + "Final Kills : " + EnumChatFormatting.GOLD + formatInt(this.classname_final_kills) + " ",
                        EnumChatFormatting.GREEN + "Final Assists : " + EnumChatFormatting.GOLD + formatInt(this.classname_final_assists_standard),
                },
                ...
                {
                        EnumChatFormatting.GREEN + "Wither Damage : " + EnumChatFormatting.GOLD + formatInt(this.classname_wither_damage) + " ",
                ...
                {
                        EnumChatFormatting.GREEN + "Blocks placed : " + EnumChatFormatting.GOLD + formatInt(this.classname_blocks_placed) + " ",
                        EnumChatFormatting.GREEN + "Meters walked : " + EnumChatFormatting.GOLD + formatInt(this.classname_meters_walked),
                }};

        IChatComponent imsg = new ChatComponentText(EnumChatFormatting.BLUE + bar() + "\n")
                .appendSibling(new ChatComponentText(centerLine(formattedname + EnumChatFormatting.GOLD + " - Game stats - " + this.classnameuppercase)));

        if (this.games_played != 1) {
            imsg.appendSibling(new ChatComponentText("\n" + centerLine(EnumChatFormatting.DARK_RED + "These stats are for " + this.games_played + " games, not one.")));
        }
    ...
    public IChatComponent getFormattedMessage(String formattedname, String playername) {
        ...
        String[][] matrix1 = {
                {
                        EnumChatFormatting.AQUA + "Kills : " + EnumChatFormatting.GOLD + formatInt(this.classname_kills) + " ",
                        EnumChatFormatting.AQUA + "Deaths : " + EnumChatFormatting.RED + formatInt(this.classname_deaths) + " ",
                        EnumChatFormatting.AQUA + "K/D Ratio : " + (this.kdr > 1 ? EnumChatFormatting.GOLD : EnumChatFormatting.RED) + String.format("%.3f", this.kdr)
                },

                {
                        EnumChatFormatting.AQUA + "Final Kills : " + EnumChatFormatting.GOLD + formatInt(this.classname_final_kills) + " ",
                        EnumChatFormatting.AQUA + "Final Deaths : " + EnumChatFormatting.RED + formatInt(this.classname_final_deaths) + " ",
                        EnumChatFormatting.AQUA + "FK/D Ratio : " + (this.fkdr > 1 ? EnumChatFormatting.GOLD : EnumChatFormatting.RED) + String.format("%.3f", this.fkdr)
                },

                {
                        EnumChatFormatting.AQUA + "Wins : " + EnumChatFormatting.GOLD + formatInt(this.classname_wins) + " ",
                        EnumChatFormatting.AQUA + "Losses : " + EnumChatFormatting.RED + formatInt(this.classname_losses) + " ",
        ...
        String[][] matrix2 = {
                ...
                {
                        EnumChatFormatting.AQUA + "Wither damage : " + EnumChatFormatting.GOLD + formatInt(this.classname_wither_damage) + "     ",
                        EnumChatFormatting.AQUA + "Defending Kills : " + EnumChatFormatting.GOLD + formatInt(this.classname_defender_kills)
                },

                {
                        EnumChatFormatting.AQUA + "Games played : " + EnumChatFormatting.GOLD + formatInt(this.games_played) + "     ",
        ...
        if (this.unlocked || this.classname.equals("hunter") || this.classname.equals("shark") || this.classname.equals("cow")) {
            ...
            msg = new ChatComponentText(EnumChatFormatting.AQUA + bar() + "\n")
                    ...
                    .appendSibling(PlanckeHeaderText(formattedname, playername, " - Mega Walls " + this.classnameuppercase + " stats"))
                    ...
                    .appendSibling(new ChatComponentText(alignText(matrix2) +
                            ...
                            centerLine(EnumChatFormatting.GREEN + "Selected skin : " + EnumChatFormatting.GOLD + (this.chosen_skin_class == null ? (this.classnameuppercase == null ? "None" : this.classnameuppercase) : this.chosen_skin_class)) + "\n" + "\n"

                            + centerLine(EnumChatFormatting.GREEN + "Classpoints : " + EnumChatFormatting.GOLD + this.classpoints + " "
                            ...
                            + (this.skill_level_d == 5 ? EnumChatFormatting.GOLD : EnumChatFormatting.DARK_GRAY) + intToRoman(this.skill_level_d) + " "
                            + (this.skill_level_a == 5 ? EnumChatFormatting.GOLD : EnumChatFormatting.DARK_GRAY) + intToRoman(this.skill_level_a) + " "
                            + (this.skill_level_b == 3 ? EnumChatFormatting.GOLD : EnumChatFormatting.DARK_GRAY) + intToRoman(this.skill_level_b) + " "
                            + (this.skill_level_c == 3 ? EnumChatFormatting.GOLD : EnumChatFormatting.DARK_GRAY) + intToRoman(this.skill_level_c) + " "
                            + (this.skill_level_g == 3 ? EnumChatFormatting.GOLD : EnumChatFormatting.DARK_GRAY) + intToRoman(this.skill_level_g) + " "

                            + EnumChatFormatting.GREEN + "Prestige : " + (this.prestige == 0 ? EnumChatFormatting.DARK_GRAY : EnumChatFormatting.GOLD) + intToRoman(this.prestige) + " "
