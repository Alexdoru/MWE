...
public class MegaWallsClassStats {
	...
	private int classname_defender_kill = 0;
	...
	public MegaWallsClassStats(JsonObject playerData, String classname) {
		 ...
		 * fields below are for the game stats
		 */
		this.games_played = JsonUtil.getInt(mwdata, this.classname + "_games_played");
		...
		this.classname_defender_kill = JsonUtil.getInt(mwdata,this.classname + "_defender_kill");
	...
	public IChatComponent getGameStatMessage(String formattedname) {
		...
		String[][] matrix1 = { 
				...
				
				{
					...
					EnumChatFormatting.GREEN + "Defender kills : " + EnumChatFormatting.GOLD + ChatUtil.formatInt(this.classname_defender_kill),
				},
		...
		if(this.unlocked || this.classname.equals("hunter") || this.classname.equals("shark") || this.classname.equals("cow") ) {
			...
			msg = new ChatComponentText(EnumChatFormatting.AQUA + ChatUtil.bar() + "\n")
					...
					.appendSibling(new ChatComponentText(
							...
							ChatUtil.centerLine(EnumChatFormatting.AQUA + "Games played : " + EnumChatFormatting.GOLD + ChatUtil.formatInt(this.games_played) + "     "
