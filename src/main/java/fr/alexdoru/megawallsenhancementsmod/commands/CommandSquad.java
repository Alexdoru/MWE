...
public class CommandSquad extends CommandBase {
	...
	public void processCommand(ICommandSender sender, String[] args) throws CommandException {
		...
		if(args[0].equalsIgnoreCase("add")) {
			...
			ChatUtil.addChatMessage((IChatComponent)new ChatComponentText(ChatUtil.getTag() + EnumChatFormatting.GREEN + "Removed all players from the squad."));
			return;
			...
			IChatComponent imsg = (IChatComponent)new ChatComponentText(ChatUtil.getTag() + EnumChatFormatting.GREEN + "Players in your squad : \n");
	...
	public List<String> addTabCompletionOptions(ICommandSender sender, String[] args, BlockPos pos) {
		...
		return args.length == 1 ? getListOfStringsMatchingLastWord(args, args1) : args.length >= 2 ? (FKCounterMod.isitPrepPhase() ? null : getListOfStringsMatchingLastWord(args, TabCompletionUtil.getOnlinePlayersByName())) : null;
	}
