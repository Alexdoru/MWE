...
public class NoCheatersConfigGuiScreen extends MyGuiScreen implements GuiSlider.ISlider {
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiSlider(4, getxCenter() - buttonsWidth / 2, getYposForButton(-1), buttonsWidth, 20, "Time between reports : ", " hours", 0.75d, 24d, ConfigHandler.timeBetweenReports / 3600000f, false, true, this));
