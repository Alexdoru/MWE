...
public class HUDsConfigGuiScreen extends MyGuiScreen implements GuiSlider.ISlider {
    ...
    public void initGui() {
        ...
        new HUDSettingGuiButtons(
                ...
                this,
                EnumChatFormatting.GRAY + "Displays the cooldown of the /kill command in Mega Walls")
                .accept(this.buttonList);
        new HUDSettingGuiButtons(
        ...
        new HUDSettingGuiButtons(
                ...
                EnumChatFormatting.GRAY + "Displays the duration of the strength when you get it - or are about to get it - with Dreadlord, Herobrine, Hunter and Zombie")
                .accept(this.buttonList);
        new HUDSettingGuiButtons(
                ...
                EnumChatFormatting.GRAY + "Displays the time it takes for the last wither to die. The HUD can be configured to appear in the Sidebar")
                .accept(this.buttonList);
        new HUDSettingGuiButtons(
                ...
                this,
                EnumChatFormatting.GRAY + "Displays the cooldown of the primed TNT when playing Creeper")
                .accept(this.buttonList);
        new HUDSettingGuiButtons(
                ...
                this,
                EnumChatFormatting.GRAY + "Displays a HUD with the amount of energy you have. Turns "
        ...
        new HUDSettingGuiButtons(
                ...
                this,
                EnumChatFormatting.GRAY + "Displays the hearts healed from a Phoenix bond")
                .accept(this.buttonList);
